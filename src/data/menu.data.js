...
export const MENU = [
  { cat: "Lunch & Dinner", sub: "Plates come with two sides", items: [
    { id: "598S0BJH4J7DE", name: "Crab Legs Platter", emoji: "🦀",
        desc: "Crab legs and shrimp with two sides", base: 50.0, lo: 50.0, hi: 50.0, prepMinutes: 30, groups: [
    ...
    { id: "VGZYVZCB2NCRY", name: "Lobster", emoji: "🦞",
        desc: "Whole lobster with two sides", base: 45.0, lo: 45.0, hi: 45.0, prepMinutes: 30, groups: [
        { gid: "YQWN3PKBKV9NG", name: "Side With Meal", kind: "side", mods: [{ n: "White Rice", p: 0.0 }, { n: "Mac And Cheese", p: 0.0 }, { n: "Rice And Peas", p: 0.0 }, { n: "Fried Chicken", p: 0.0 }, { n: "Festival", p: 0.0 }, { n: "Pasta", p: 0.0 }, { n: "Shrimp", p: 5.0 }, { n: "Whiting Fish X1", p: 0.0 }, { n: "Mashed Potatoes", p: 0.0 }, { n: "Waffles", p: 0.0 }, { n: "Seafood Mac", p: 3.5 }, { n: "Candied Yams", p: 0.0 }, { n: "Steam Veg.", p: 0.0 }, { n: "Plaintain", p: 0.0 }] }
      ] },
    { id: "7916EWVQFPGH8", name: "Lamb", emoji: "🥩",
        desc: "Slow-braised lamb with two sides", base: 30.0, lo: 30.0, hi: 30.0, prepMinutes: 30, groups: [
        { gid: "YQWN3PKBKV9NG", name: "Side With Meal", kind: "side", mods: [{ n: "White Rice", p: 0.0 }, { n: "Mac And Cheese", p: 0.0 }, { n: "Rice And Peas", p: 0.0 }, { n: "Fried Chicken", p: 0.0 }, { n: "Festival", p: 0.0 }, { n: "Pasta", p: 0.0 }, { n: "Shrimp", p: 5.0 }, { n: "Whiting Fish X1", p: 0.0 }, { n: "Mashed Potatoes", p: 0.0 }, { n: "Waffles", p: 0.0 }, { n: "Seafood Mac", p: 3.5 }, { n: "Candied Yams", p: 0.0 }, { n: "Steam Veg.", p: 0.0 }, { n: "Plaintain", p: 0.0 }] }
      ] },
    { id: "VQZ0T4XK707EC", name: "Snapper Fish", emoji: "🐠",
        desc: "Brown stew, escovitch, or steamed", base: 0.0, lo: 30.0, hi: 30.0, prepMinutes: 30, groups: [
        { gid: "YQWN3PKBKV9NG", name: "Side With Meal", kind: "side", mods: [{ n: "White Rice", p: 0.0 }, { n: "Mac And Cheese", p: 0.0 }, { n: "Rice And Peas", p: 0.0 }, { n: "Fried Chicken", p: 0.0 }, { n: "Festival", p: 0.0 }, { n: "Pasta", p: 0.0 }, { n: "Shrimp", p: 5.0 }, { n: "Whiting Fish X1", p: 0.0 }, { n: "Mashed Potatoes", p: 0.0 }, { n: "Waffles", p: 0.0 }, { n: "Seafood Mac", p: 3.5 }, { n: "Candied Yams", p: 0.0 }, { n: "Steam Veg.", p: 0.0 }, { n: "Plaintain", p: 0.0 }] },
    ...
    { id: "ZTAQ37M4E9S4C", name: "Stew Peas", emoji: "🫘",
        desc: "Red peas simmered in coconut milk", base: 0.0, lo: 15.0, hi: 18.0, prepMinutes: 15, groups: [
    ...
    { id: "32VDQ4G5J131P", name: "Seafood Stew Peas", emoji: "🫘",
        desc: "Stew peas loaded with seafood. One size, large.", days: [5, 6], base: 30.0, lo: 30.0, hi: 30.0, prepMinutes: 30, groups: [
      ] },
    { id: "60KCQ1V22Q98M", name: "Oxtail", emoji: "🍖",
        desc: "Slow-cooked, fall-off-the-bone tender", base: 0.0, lo: 20.0, hi: 25.0, prepMinutes: 15, groups: [
        { gid: "45KGD3ZDMT2ZY", name: "Oxtail Size", kind: "variant", mods: [{ n: "Medium", p: 20.0 }, { n: "Large", p: 25.0 }] },
        { gid: "YQWN3PKBKV9NG", name: "Side With Meal", kind: "side", mods: [{ n: "White Rice", p: 0.0 }, { n: "Mac And Cheese", p: 0.0 }, { n: "Rice And Peas", p: 0.0 }, { n: "Fried Chicken", p: 0.0 }, { n: "Festival", p: 0.0 }, { n: "Pasta", p: 0.0 }, { n: "Shrimp", p: 5.0 }, { n: "Whiting Fish X1", p: 0.0 }, { n: "Mashed Potatoes", p: 0.0 }, { n: "Waffles", p: 0.0 }, { n: "Seafood Mac", p: 3.5 }, { n: "Candied Yams", p: 0.0 }, { n: "Steam Veg.", p: 0.0 }, { n: "Plaintain", p: 0.0 }] }
      ] },
    { id: "JAD3BJK9BSTW8", name: "Pasta", emoji: "🍝",
        desc: "Plain, chicken, shrimp, steak, or oxtail", base: 0.0, lo: 15.0, hi: 25.0, prepMinutes: 15, groups: [
    ...
    { id: "H9520PFNBT2NY", name: "Salmon", emoji: "🐟",
        desc: "Honey garlic, jerk, sweet chili, grilled, or steamed", base: 0.0, lo: 22.0, hi: 22.0, prepMinutes: 30, groups: [
    ...
    { id: "AYBW9QMTC6154", name: "Ackee & Shrimp", emoji: "🍤",
        desc: "Ackee and shrimp with two sides", base: 20.0, lo: 20.0, hi: 20.0, prepMinutes: 30, groups: [
        { gid: "YQWN3PKBKV9NG", name: "Side With Meal", kind: "side", mods: [{ n: "White Rice", p: 0.0 }, { n: "Mac And Cheese", p: 0.0 }, { n: "Rice And Peas", p: 0.0 }, { n: "Fried Chicken", p: 0.0 }, { n: "Festival", p: 0.0 }, { n: "Pasta", p: 0.0 }, { n: "Shrimp", p: 5.0 }, { n: "Whiting Fish X1", p: 0.0 }, { n: "Mashed Potatoes", p: 0.0 }, { n: "Waffles", p: 0.0 }, { n: "Seafood Mac", p: 3.5 }, { n: "Candied Yams", p: 0.0 }, { n: "Steam Veg.", p: 0.0 }, { n: "Plaintain", p: 0.0 }] }
      ] },
    { id: "VHHCS7EDV70HC", name: "Shrimp", emoji: "🍤",
        desc: "Sweet chili, garlic, curried, pepper, grilled, or fried", base: 0.0, lo: 20.0, hi: 20.0, prepMinutes: 30, groups: [
        { gid: "YQWN3PKBKV9NG", name: "Side With Meal", kind: "side", mods: [{ n: "White Rice", p: 0.0 }, { n: "Mac And Cheese", p: 0.0 }, { n: "Rice And Peas", p: 0.0 }, { n: "Fried Chicken", p: 0.0 }, { n: "Festival", p: 0.0 }, { n: "Pasta", p: 0.0 }, { n: "Shrimp", p: 5.0 }, { n: "Whiting Fish X1", p: 0.0 }, { n: "Mashed Potatoes", p: 0.0 }, { n: "Waffles", p: 0.0 }, { n: "Seafood Mac", p: 3.5 }, { n: "Candied Yams", p: 0.0 }, { n: "Steam Veg.", p: 0.0 }, { n: "Plaintain", p: 0.0 }] },
    ...
    { id: "8FW3GVMJKCGZG", name: "Pork", emoji: "🥓",
        desc: "Stew or jerk, medium or large", base: 0.0, lo: 20.0, hi: 25.0, prepMinutes: 15, groups: [
        { gid: "YQWN3PKBKV9NG", name: "Side With Meal", kind: "side", mods: [{ n: "White Rice", p: 0.0 }, { n: "Mac And Cheese", p: 0.0 }, { n: "Rice And Peas", p: 0.0 }, { n: "Fried Chicken", p: 0.0 }, { n: "Festival", p: 0.0 }, { n: "Pasta", p: 0.0 }, { n: "Shrimp", p: 5.0 }, { n: "Whiting Fish X1", p: 0.0 }, { n: "Mashed Potatoes", p: 0.0 }, { n: "Waffles", p: 0.0 }, { n: "Seafood Mac", p: 3.5 }, { n: "Candied Yams", p: 0.0 }, { n: "Steam Veg.", p: 0.0 }, { n: "Plaintain", p: 0.0 }] },
    ...
    { id: "PSGB77QNZR2WM", name: "Blue Crab", emoji: "🦀",
        desc: "Blue crab with two sides", base: 20.0, lo: 20.0, hi: 20.0, prepMinutes: 30, groups: [
        { gid: "YQWN3PKBKV9NG", name: "Side With Meal", kind: "side", mods: [{ n: "White Rice", p: 0.0 }, { n: "Mac And Cheese", p: 0.0 }, { n: "Rice And Peas", p: 0.0 }, { n: "Fried Chicken", p: 0.0 }, { n: "Festival", p: 0.0 }, { n: "Pasta", p: 0.0 }, { n: "Shrimp", p: 5.0 }, { n: "Whiting Fish X1", p: 0.0 }, { n: "Mashed Potatoes", p: 0.0 }, { n: "Waffles", p: 0.0 }, { n: "Seafood Mac", p: 3.5 }, { n: "Candied Yams", p: 0.0 }, { n: "Steam Veg.", p: 0.0 }, { n: "Plaintain", p: 0.0 }] }
      ] },
    { id: "QB9EKT4QGVWDA", name: "Shrimp & Waffles", emoji: "🧇",
        desc: "Shrimp over waffles, six flavors to pick from", base: 20.0, lo: 20.0, hi: 20.0, prepMinutes: 30, groups: [
        { gid: "YQWN3PKBKV9NG", name: "Side With Meal", kind: "side", mods: [{ n: "White Rice", p: 0.0 }, { n: "Mac And Cheese", p: 0.0 }, { n: "Rice And Peas", p: 0.0 }, { n: "Fried Chicken", p: 0.0 }, { n: "Festival", p: 0.0 }, { n: "Pasta", p: 0.0 }, { n: "Shrimp", p: 5.0 }, { n: "Whiting Fish X1", p: 0.0 }, { n: "Mashed Potatoes", p: 0.0 }, { n: "Waffles", p: 0.0 }, { n: "Seafood Mac", p: 3.5 }, { n: "Candied Yams", p: 0.0 }, { n: "Steam Veg.", p: 0.0 }, { n: "Plaintain", p: 0.0 }] },
    ...
    { id: "C2RD25C1VXNN0", name: "Wings", emoji: "🔥",
        desc: "Made to order. Pick your sauce.", base: 0.0, lo: 15.0, hi: 18.0, prepMinutes: 15, groups: [
    ...
    { id: "NEAR47KAE44HC", name: "Curried Goat", emoji: "🍛",
        desc: "Tender island-style curry goat", base: 0.0, lo: 15.0, hi: 18.0, prepMinutes: 15, groups: [
        { gid: "YQWN3PKBKV9NG", name: "Side With Meal", kind: "side", mods: [{ n: "White Rice", p: 0.0 }, { n: "Mac And Cheese", p: 0.0 }, { n: "Rice And Peas", p: 0.0 }, { n: "Fried Chicken", p: 0.0 }, { n: "Festival", p: 0.0 }, { n: "Pasta", p: 0.0 }, { n: "Shrimp", p: 5.0 }, { n: "Whiting Fish X1", p: 0.0 }, { n: "Mashed Potatoes", p: 0.0 }, { n: "Waffles", p: 0.0 }, { n: "Seafood Mac", p: 3.5 }, { n: "Candied Yams", p: 0.0 }, { n: "Steam Veg.", p: 0.0 }, { n: "Plaintain", p: 0.0 }] },
    ...
    { id: "433FBT50JEVY8", name: "Pork Ribs", emoji: "🍖",
        desc: "Pork ribs with two sides", base: 18.0, lo: 18.0, hi: 18.0, prepMinutes: 15, groups: [
        { gid: "YQWN3PKBKV9NG", name: "Side With Meal", kind: "side", mods: [{ n: "White Rice", p: 0.0 }, { n: "Mac And Cheese", p: 0.0 }, { n: "Rice And Peas", p: 0.0 }, { n: "Fried Chicken", p: 0.0 }, { n: "Festival", p: 0.0 }, { n: "Pasta", p: 0.0 }, { n: "Shrimp", p: 5.0 }, { n: "Whiting Fish X1", p: 0.0 }, { n: "Mashed Potatoes", p: 0.0 }, { n: "Waffles", p: 0.0 }, { n: "Seafood Mac", p: 3.5 }, { n: "Candied Yams", p: 0.0 }, { n: "Steam Veg.", p: 0.0 }, { n: "Plaintain", p: 0.0 }] }
      ] },
    { id: "QFNQ2XQB8SPN6", name: "Fried chicken", emoji: "🍗",
        desc: "Fried to order, medium or large", base: 0.0, lo: 13.0, hi: 16.0, prepMinutes: 15, groups: [
    ...
    { id: "SJGN0N254K8KE", name: "Jerk Chicken", emoji: "🍗",
        desc: "Jerk chicken with two sides", base: 0.0, lo: 14.0, hi: 16.0, prepMinutes: 15, groups: [
    ...
    { id: "1PBGJ1BWC3Z52", name: "Chicken & Waffles", emoji: "🧇",
        desc: "Fried chicken over waffles, six flavors", base: 15.0, lo: 15.0, hi: 15.0, prepMinutes: 15, groups: [
        { gid: "YQWN3PKBKV9NG", name: "Side With Meal", kind: "side", mods: [{ n: "White Rice", p: 0.0 }, { n: "Mac And Cheese", p: 0.0 }, { n: "Rice And Peas", p: 0.0 }, { n: "Fried Chicken", p: 0.0 }, { n: "Festival", p: 0.0 }, { n: "Pasta", p: 0.0 }, { n: "Shrimp", p: 5.0 }, { n: "Whiting Fish X1", p: 0.0 }, { n: "Mashed Potatoes", p: 0.0 }, { n: "Waffles", p: 0.0 }, { n: "Seafood Mac", p: 3.5 }, { n: "Candied Yams", p: 0.0 }, { n: "Steam Veg.", p: 0.0 }, { n: "Plaintain", p: 0.0 }] },
        { gid: "3VQCJ6J8Q465P", name: "Waffles Flavors", kind: "flavor", mods: [{ n: "Red Velvet", p: 0.0 }, { n: "Strawberry", p: 0.0 }, { n: "Easter Bun", p: 0.0 }, { n: "Cinnamin", p: 0.0 }, { n: "Buttermilk", p: 0.0 }, { n: "Coconut Toto", p: 0.0 }] }
      ] },
    { id: "VTKZ1S1K3GPK8", name: "Brown Stew Chicken", emoji: "🍛",
        desc: "Chicken braised down in brown stew gravy", base: 0.0, lo: 13.0, hi: 15.0, prepMinutes: 15, groups: [
    ...
    { id: "9WV3BMMSC8G5E", name: "Soup", emoji: "🥣",
        desc: "Chicken, goat, or seafood", base: 0.0, lo: 5.0, hi: 15.0, prepMinutes: 15, groups: [
    ...
    { id: "6NX7XK602V0ZM", name: "Side", emoji: "🍚",
        desc: "One side on its own", base: 0.0, lo: 1.0, hi: 15.0, prepMinutes: 15, noPrep: true, groups: [
    ...
    { id: "KW21XBQ6XVTGA", name: "Lunch Specials", emoji: "☀️",
        desc: "Smaller plates at lunch prices", base: 0.0, lo: 2.0, hi: 8.0, prepMinutes: 15, groups: [
  ...
  { cat: "Seafood Fridays", sub: "Fridays only", items: [
    { id: "BRMP82TR0Z45C", name: "Crab Legs Platter (Shrimp & 2 Sides)", emoji: "🦀",
        desc: "Crab legs with shrimp and two sides", days: [5], base: 39.99, lo: 39.99, hi: 39.99, prepMinutes: 30, groups: [
      ] },
    { id: "A1YZ2ZD5CA1SW", name: "Lobster Platter (Shrimp & 2 Sides)", emoji: "🦞",
        desc: "Lobster with shrimp and two sides", days: [5], base: 39.99, lo: 39.99, hi: 39.99, prepMinutes: 30, groups: [
      ] },
    { id: "06Z80836S0GZR", name: "Fish Platter (Shrimp & 2 Sides)", emoji: "🐠",
        desc: "Fish with shrimp and two sides", days: [5], base: 30.0, lo: 30.0, hi: 30.0, prepMinutes: 30, groups: [
      ] },
    { id: "CAFAH5FKPTRW8", name: "Shrimp", emoji: "🍤",
        desc: "Shrimp with two sides", days: [5], base: 21.99, lo: 21.99, hi: 21.99, prepMinutes: 30, groups: [
      ] },
    { id: "0NQ5E11VABFDY", name: "Salmon (Shrimp & 2 Sides)", emoji: "🍽️",
        desc: "Salmon with shrimp and two sides", days: [5], base: 21.99, lo: 21.99, hi: 21.99, prepMinutes: 30, groups: [
      ] },
  ]},
  { cat: "Drinks", sub: "Refreshing beverages", items: [
    { id: "EWT1J5Q9K7KX0", name: "Pina Colada", emoji: "🍹",
        desc: "Mango, pina colada, or mixed", base: 0.0, lo: 5.0, hi: 12.5, prepMinutes: 15, noPrep: true, groups: [
    ...
    { id: "D7MBX5PWRCGCE", name: "Drink", emoji: "🥤",
        desc: "Sodas, juices, and coconut water", base: 0.0, lo: 1.0, hi: 6.0, prepMinutes: 15, noPrep: true, groups: [
